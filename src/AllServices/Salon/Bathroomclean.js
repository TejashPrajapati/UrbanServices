...
import IPPORT from '../../IPport';
  ...
  const Bathroomclean = ({navigation}) => {
    ...
    const postData = async (item) => {
      try {
        ...
        showMessage({
          message: "Success",
          description: "Services Added To Wishlist",
          type: "danger",
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
        ...
        <ImageBackground
          style={{ flex: 0.7 , height:450 , width: 450  }}
          source={require("../database/images/products/kitchen.jpg")}
        >
                  ...
                  <View>
                    ...
                    {wishlist.includes(item) ?(
                      <TouchableOpacity 
                         onPress={() =>
                              setWishlist(
                                wishlist.filter((x) => x.id !== item.id, item.name)
                              )
                            }
                       >
