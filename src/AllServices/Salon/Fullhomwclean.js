...
import IPPORT from '../../IPport';
  ...
  const Fullhomwclean = ({navigation}) => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `http://${IPPORT}:4000/api/homecleaning`
        );
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
        ...
        <ImageBackground
          style={{ flex: 0.7 }}
          source={require("../../AllServices/database/images/products/clenar1.jpg")}
        >
