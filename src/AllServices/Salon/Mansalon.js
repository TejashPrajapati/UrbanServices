  ...
  const Mansalon = ({navigation}) => {
    ...
    const bookingData = async (item) => {
      try {
        ...
        showMessage({
          message: "Success",
          description: "Services Added To Booking",
          type: "success",
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
        ...
        <ImageBackground
          ...
          source={require("../database/images/products/man.jpg")}
        >
